...
namespace {
    ...
    class Lookup extends \Soknann\Reg\Facades\Lookup{
         ...
         * @static 
         */
        public static function getUserActiveList(){
            return \Soknann\Reg\Libraries\Lookup::getUserActiveList();
        }
        ...
        public static function getGroupList(){
            return \Soknann\Reg\Libraries\Lookup::getGroupList();
        }
         ...
         * @static 
         */
        public static function getStudentGender(){
            return \Soknann\Reg\Libraries\Lookup::getStudentGender();
        }
        ...
        public static function getStudentList(){
            return \Soknann\Reg\Libraries\Lookup::getStudentList();
        }
        
    }


    class Action extends \Soknann\Reg\Facades\Action{
        ...
        public static function make(){
            return \Soknann\Reg\Libraries\Action::make();
        }
         ...
         * @static 
         */
        public static function edit($url, $validator = true){
            return \Soknann\Reg\Libraries\Action::edit($url, $validator);
        }
         ...
         * @static 
         */
        public static function delete($url, $item = '', $validator = true){
            return \Soknann\Reg\Libraries\Action::delete($url, $item, $validator);
        }
         ...
         * @static 
         */
        public static function show($url, $validator = true){
            return \Soknann\Reg\Libraries\Action::show($url, $validator);
        }
         ...
         * @static 
         */
        public static function custom($url, $title, $validator = true){
            return \Soknann\Reg\Libraries\Action::custom($url, $title, $validator);
        }
        ...
        public static function divider(){
            return \Soknann\Reg\Libraries\Action::divider();
        }
        ...
        public static function header($title){
            return \Soknann\Reg\Libraries\Action::header($title);
        }
         ...
         */
        public static function get(){
            return \Soknann\Reg\Libraries\Action::get();
        }
