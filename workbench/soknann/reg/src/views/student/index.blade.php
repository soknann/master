...
<div class="inner col-lg-12">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><i class="icon-list"></i> List Of Student</h1>
            <p>
               <a class="btn btn-primary" href="{{route('reg.student.add')}}">
                    <i class="icon-folder-open"></i> Add New
               </a>

                <a class="btn btn-primary" href="{{route('reg.student.rpt')}}">
                    <i class="icon-print"></i> Print Student List
                </a>
